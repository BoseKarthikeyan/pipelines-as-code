...
// If no on_cel is provided, the role runs for any completed PipelineRun.
func shouldTriggerRole(role v1alpha1.AnalysisRole, celContext map[string]any, _ *tektonv1.PipelineRun) (bool, error) {
	if role.OnCEL == "" {
		return true, nil
	}
